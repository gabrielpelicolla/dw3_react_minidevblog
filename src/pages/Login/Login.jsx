...
const Login = () => {
  ...
  return (
    <div className={styles.login}>
      ...
      <p>Entre no ambiente onde ideias viram código!</p>
      <form onSubmit={handlerSubmit}>
        <label>
          <span>E-Mail</span>
          <input type='email' name='email' required value={email} onChange={(e) => setEmail(e.target.value)} placeholder='Entre com seu e-mail'/>
        </label>
        <label>
          <span>Senha</span>
